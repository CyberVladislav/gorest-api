                                ...
                                @foreach($users as $user)
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <form action="{{ asset('users/'.$user['id']) }}" method="post" style="display: inline-block">
                                                @csrf
                                                @method('DELETE')
                                                <button type="submit" style="all: unset;"><a href="#" data-toggle="tooltip" data-original-title="Delete"><i class="far fa-trash-alt"></i></a></button>
                                            </form>
                                        </td>
                                    </tr>
                                @endforeach
